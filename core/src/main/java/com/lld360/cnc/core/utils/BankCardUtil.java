...
/**
 * Created by McGrady.fang on 2017/3/16.
 */
public class BankCardUtil {
   ...
   卡号前6位为622126至622925之一的银行卡，是中国银行卡产业共有的民族品牌。*/
    private final static int[] bankNameBin = {
    ...
    private static final String[] bankName = {
            ...
            "浦东发展银行·浦发万事达金卡", "浦东发展银行·浦发万事达普卡", "浦东发展银行·浦发单币卡", "浦东发展银行·浦发银联单币麦兜普卡", "浦东发展银行·东方轻松理财卡", "浦东发展银行·东方轻松理财卡普卡", "浦东发展银行·东方轻松理财卡",
            ...
            "浦东发展银行·东方标准准贷记卡", "浦东发展银行·轻松理财金卡（复合卡）", "浦东发展银行·轻松理财白金卡（复合卡）", "浦东发展银行·轻松理财钻石卡（复合卡）", "浦东发展银行·东方卡", "恒丰银行·九州IC卡",
    ...
    public static String getNameOfBank(String charBin, int offset) {
        ...
        index = binarySearch(bankNameBin, bin);

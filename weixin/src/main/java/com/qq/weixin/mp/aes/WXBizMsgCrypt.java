...
public class WXBizMsgCrypt {
    ...
    public String decryptMsg(String msgSignature, String timeStamp, String nonce, String postData)
        ...
        return decryptString(msgSignature, timeStamp, nonce, encrypt);
    }
     ...
     * @throws AesException 执行失败，请查看该异常的错误码和具体的错误信息
     */
    public String decryptString(String msgSignature, String timeStamp, String nonce, String encryptStr) throws AesException {
        // 验证安全签名

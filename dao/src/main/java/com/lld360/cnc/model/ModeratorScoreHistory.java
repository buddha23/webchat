...
public class ModeratorScoreHistory implements Serializable {
    /**
     * id
     */
    ...
    public ModeratorScoreHistory() {
        this.createTime = Calendar.getInstance(Locale.CHINA).getTime();
    }

    public ModeratorScoreHistory(Long userId, Byte type, Integer scoreChange, Long objectId, String description) {
        this.userId = userId;
        this.type = type;

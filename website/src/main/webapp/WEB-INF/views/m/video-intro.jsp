        ...
        <div class="video-intro">
            ...
            <div class="section tabs">
                <ul class="section-tab tabs-nav clearfix">
                    <li class="tab-menu tabs-nav-item current js-details">详情</li>
                    <li class="tab-menu tabs-nav-item js-catalog">目录</li>
                    ...
                    <div class="tab">
                        <div class="tutorial-intro">
                            ...
                            <div>
                                ...
                                <input style="display: none" id="volContent" value="${fn:escapeXml(vodVolumes.content)}"/>

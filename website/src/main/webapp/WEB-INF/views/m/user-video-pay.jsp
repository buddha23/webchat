        ...
        <div class="score-buy">
            ...
            <div class="buy-wrapper">
                <ol>
                    ...
                    <li><a href="${ctx}/m/user/buyVip" target="blank"
                           style="color:red;">VIP尊享价</a>: ${vodVolumes.costScore * discount} 牛人币
                    </li>
            ...
            <div class="buy-wrapper" style="padding-bottom: 30px;">
                ...
                <a class="button btn-light btn-large input-full margintop15" type="button"
                   href="javascript:history.back()">返回</a>
            </div>
        </div>
    </div>

    <form id="orderForm" action="${ctx}/video/alipay" method="post" style="display: none;">
        <input type="hidden" name="volumeId" id="volumeId" value="${vodVolumes.id}"/>
    </form>
...
<script>
    ...
    function dnbPay() {
        $.ajax({
            ...
            error: function (r) {
                var msg = JSON.parse(r.responseText).message;
                var a = ' 前往 <a href="${ctx}/m/user/scoreRecharge" target="_blank" style="text-decoration:underline;color:red;">充值</a>';

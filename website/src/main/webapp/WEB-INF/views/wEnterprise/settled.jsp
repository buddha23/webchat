             ...
             <div class="box-header">
                ...
                <div class="box-content">
                    <form id="page-form" class="page-form business-form margintop15"  action="${ctx}/enterprise/settled" method="post">
                            ...
                            <div class="field">
                            <c:choose>
                              <c:when test="${certification.state==1}">审核中</c:when>
                              <c:when test="${certification.state==2}">审核通过</c:when>
                              <c:when test="${certification.state==3}">审核失败</c:when>
                            </c:choose>
                        ...
                        <div class="row">
                            ...
                            <div class="field">
                                <div style="display:none">
                                 ...
                                 <input type="text" id="imgPath" class="validate[required]" style="width:0;height:0;margin-left:-500px;" name="registrationImg" value="${certification.registrationImg}" />
